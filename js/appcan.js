...
var isSML = (window.navigator.platform == 'Win32' || window.navigator.platform == 'MacIntel' ) ? 1 : 0;
if(isSML){
    localStorage.setItem('tobacco.login.accessToken','8955203b-9647-40f8-97c5-def7fda82e32');//8955203b-9647-40f8-97c5-def7fda82e32
}
var Zepto = (function() {
...
;(function($){
  ...
  $(document).ready(function(){
    ...
    //forbidden to bounce if touch moving in x axis
    var sbounceState = 0;
    window.fbounceState = 0;
    appcan.ready(function(){
      if(uexWindow && uexWindow.getBounce && typeof uexWindow.getBounce === 'function'){
        appcan.window.getBounceStatus(function(dt,dataType,opId){
          window.fbounceState = dt;
        });
      }
    })
    ...
    $(document)
      ...
      .on(touchMove, function(e){
        ...
        if(deltaX > 10  && sbounceState == 0 && deltaX > deltaY) {appcan.window.disableBounce();sbounceState=1;}
      })
      .on(touchEnd, function(e){
        if(window.fbounceState){
